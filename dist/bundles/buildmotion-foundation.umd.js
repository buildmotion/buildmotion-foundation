(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'buildmotion-logging', 'rxjs/observable', 'angular-actions', 'angular-rules-engine', '@angular/http', 'rxjs/add/operator/cache', 'rxjs/Rx', 'buildmotion-logging/severity.enum', 'buildmotion-logging/logging.service', 'rxjs'], factory) :
	(factory((global.buildmotionFoundation = {}),global.ng.core,global.ng.common,global.buildmotionLogging,global.Rx.Observable.prototype,global.angularActions,global.angularRulesEngine,global.ng.http,null,global.Rx,global['buildmotionLogging/Severity'],global['buildmotionLogging/LoggingService'],global.Rx));
}(this, (function (exports,core,common,buildmotionLogging,observable,angularActions,angularRulesEngine,http,cache,Rx,severity_enum,logging_service,rxjs) { 'use strict';
